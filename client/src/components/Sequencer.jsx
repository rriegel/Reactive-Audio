  ...
  togglePlay() {
    if (Tone.Transport.state === 'stopped') {
      ...
      let repeat = ( time ) => {
        ...
        row1[index] === 1 ? sampler.triggerAttackRelease(`${this.props.notes[1]}${this.props.octaves[1]}`, '8n', time) : null;
      ...
      <table className='sequencer'>
        <tbody>
          ...
          <SequencerRow
            ...
            sampler={ sampler }
          />
          <SequencerRow checked={this.props.checked} row='2' boxToggle={ this.props.boxToggle } sampler={ sampler } />
          <SequencerRow checked={this.props.checked} row='3' boxToggle={ this.props.boxToggle } sampler={ sampler } />
        </tbody>
      </table>
    )
  }
